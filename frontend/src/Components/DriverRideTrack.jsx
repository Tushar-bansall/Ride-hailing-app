      ...
      return (
        <div className='w-full'>
            <div className='bg-black text-white rounded-t-2xl w-full flex justify-between p-4 h-fit'>
                <p>⏳ {rideStart ? "You will reach the destination point in" : "You will reach the pickup point in"}</p>            
                ...
                <div className='flex w-full pt-4 justify-between '>
                    <div className='flex gap-3'>
                        ...
                        <div className='flex flex-col my-auto'>
                            <p className='text-base text-gray-950 font-semibold'>{userId?.fullName}</p>
...
export default DriverRideTrack